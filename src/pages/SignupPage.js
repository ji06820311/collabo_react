        ...
        <Container className="d-flex justify-content-center align-items-center" style={{ height: '70vh' }}>
            <Row className="w-100 justify-content-center">
                <Col md={6}>
                    <Card>
                        <Card.Body>
                            <h2 className="text-center md-4">회원가입</h2>

                            {/* 일반 오류 발생시 사용자에게 alert 메세지를 보여 줍니다. */}
                            {/* contextual : 상황에 맞는 적절한 스타일 색상을 지정하는 기법 */}
                            {errors.general && <Alert variant="danger">{errors.general}</Alert>}

                            {/*
                               !! 연산자는 어떤한 값을 강제로 boolean 형태로 변환해주는 자바스크립트 기법입니다.

                               isInvalid 속성은 해당 control의 유효성을 검사하는 속성입니다.
                               값이 true이면 입력 Form.Control.Feedback에 빨간 색상으로 오류 메세지를 보여 줍니다. 
                            */}
